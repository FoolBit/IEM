...
%%
hfdata = rawdata_probe31;
n_tpt = size(hfdata{1},3);

%% data data
chan_resp_aligned_all = nan(6, n_tpt, 31, 2);
recons_aligned_all = nan(180, n_tpt, 31, 2);
all_fidelity_all = nan(n_tpt, 31, 2);
slope_all_all = nan(n_tpt, 31, 2);
decode_errs_all = nan(n_tpt, 31, 2);
